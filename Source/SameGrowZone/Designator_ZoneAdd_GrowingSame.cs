...
namespace RimWorld
{
	...
	public class Designator_ZoneAdd_GrowingSame : Designator_ZoneAdd_Growing
	{
		...
		public Designator_ZoneAdd_GrowingSame()
		{
			...
			defaultLabel = Translator.Translate("GrowingZoneSame");
			defaultDesc = Translator.Translate("DesignatorGrowingZoneSameDesc");
		...
		public override AcceptanceReport CanDesignateCell(IntVec3 c)
		{
			...
			else if (base.Map.fertilityGrid.FertilityAt(c) != base.Map.fertilityGrid.FertilityAt(startPoint))
			{
				result = false;
			}
			else
